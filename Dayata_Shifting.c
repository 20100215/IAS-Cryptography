/**
 *  CRYPTOGRAPHY SIMULATION: [2] Caesar Cipher/Shifting Cipher
...
do{
        ...
        //HEADER
        printf("\n---------------------------------------------------------------------");
        printf("\n------ CRYPTOGRAPHY SIMULATION (Caesar Cipher/Shifting Cipher) ------");
